 ...
 */
public abstract class VhdlAbstractDeclarativeScopeProvider extends AbstractScopeProvider implements IDelegatingScopeProvider {
	...
	public IScope getScope(EObject context, EReference reference) {
		...
		polymorphicFindScopeForClassName(context, reference);
		if (scope == null) {
